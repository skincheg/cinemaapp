    ...
    var body: some View {
        ZStack() {
            ...
            ZStack {
                ...
                VideoPlayer(player: AVPlayer(url: (appData.videoUrl ?? URL(string: "https://i.imgur.com/BemjriO.mp4")!)))
                    .frame(height: 500)
                
                Button {
                    withAnimation {
                        movieAboutData.isShowingVideo.toggle()
                    }
                } label: {
            ...
            .zIndex(movieAboutData.isShowingVideo ? 10 : -1)
